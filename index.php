...
<body>
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            <h3 class="sideber__panel"><i id="left" class="fas fa-laugh-wink"></i> St Mary's Pharma</h3>
    ...
    echo " active";
        ...
        <footer class="text-center"><span>SMP</span><br>St Mary's pharmaceutical industry<br> @all rights reserved 2016</footer>
    </section>
    <!--------------------------------- #Sideber -------------------------------->
